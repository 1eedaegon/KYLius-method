...
# initialize
saver=tf.train.import_meta_graph("desktop/git/daegon/KYLius-method/승혁/opt2/opt2.meta")
sess = tf.InteractiveSession()
saver.restore(sess, tf.train.get_checkpoint_state("desktop/git/daegon/KYLius-method/승혁/opt2/").model_checkpoint_path)
