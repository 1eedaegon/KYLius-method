...
W1_2 = tf.get_variable("W1_2", shape=[2, 43, 32, 32],initializer=tf.contrib.layers.xavier_initializer())
...
W2_2 = tf.get_variable("W2_2", shape=[3, 3, 64, 64],initializer=tf.contrib.layers.xavier_initializer())
...
W3_2 = tf.get_variable("W3_2", shape=[3, 3, 128, 128],initializer=tf.contrib.layers.xavier_initializer())
