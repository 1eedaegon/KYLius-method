...
np.savetxt("c:/home/itwill03/sound/X_train.csv",X_train, delimiter=",")
np.savetxt("c:/home/itwill03/sound/X_test.csv",X_train, delimiter=",")
...
L1 = tf.nn.max_pool(L1, ksize=[1, 2, 18, 1],strides=[1, 2, 18, 1], padding='SAME') 
...
accuracy: 61~62%
13) con2d layer * 3 + FC # V_40,350 코스트는 계속해서 내려가나 (0.14까지 나옴) 정확도는 그대로임
lr=0.0002, epoch = 700    
p_keep_conv, p_keep_hidden = 0.8, 0.7
win : (4, 35, 32), (3, 3, 64), (3, 3, 128)
FC : (2*2*128, 410), (410, 41)
max_pool : (4,35), (3,3), (2,2)
accuracy: 64~72%
"""
